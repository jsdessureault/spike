...
rospy.init_node('node_joue_son', anonymous=False)
...
soundAssets = '/home/pi/ros_catkin_ws/src/spike/assets/sounds/'
nomWav = 'robot.wav'

sh = soundhandle.say("Hello world")
...
def callback(data):
        ...
        if data.command == SAY:
            ...
            rospy.loginfo(rospy.get_caller_id() + "A parler..." + entree)
            #sh.play()
        rospy.sleep(2)
